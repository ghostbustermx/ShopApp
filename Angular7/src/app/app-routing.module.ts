...
const routes: Routes = [
  ...
  //{path: 'shop', component: MainPageComponent,canActivate: [AuthGuard], data : {permittedRoles: ['Customer','Admin','Registered', '']}},
  
  //gman
  {path: 'shop', component: MainPageComponent},

  //gman
  {path: 'shop/productsList', component: ProductsListComponent},
  ...
  {path: 'adminpanel', canActivate: [AuthGuard], data : {permittedRoles: ['Admin']}, redirectTo: '/shop'}
  ];
